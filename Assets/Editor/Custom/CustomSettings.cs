...
public static class CustomSettings
{
    ...
    {                
        ...
        _GT(typeof(UnityEngine.TextGenerationSettings)),
        _GT(typeof(UnityEngine.TextGenerator)),
        _GT(typeof(Font)),
        _GT(typeof(CharacterInfo)),
        _GT(typeof(FontStyle)),
        _GT(typeof(UILineInfo)),
        _GT(typeof(List<UILineInfo>)),
        
        _GT(typeof(AppConst)),
        _GT(typeof(CacheTool)),
        _GT(typeof(ZipTool)),
        _GT(typeof(ICSharpCode.SharpZipLib.Zip.ZipInputStream)),
        ...
        _GT(typeof(ToLuaFramework.MgrThread)),
        _GT(typeof(ToLuaFramework.ThreadEvent)),
