...
public class UnityEngine_CharacterInfoWrap
{
	...
	{
		L.BeginClass(typeof(UnityEngine.CharacterInfo), null);
	...
	static int get_advance(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index advance on a nil value" : e.Message);
		}
	}
	...
	static int get_glyphWidth(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index glyphWidth on a nil value" : e.Message);
		}
	}
	...
	static int get_glyphHeight(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index glyphHeight on a nil value" : e.Message);
		}
	}
	...
	static int get_bearing(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index bearing on a nil value" : e.Message);
		}
	}
	...
	static int get_minY(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index minY on a nil value" : e.Message);
		}
	}
	...
	static int get_maxY(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index maxY on a nil value" : e.Message);
		}
	}
	...
	static int get_uvBottomLeft(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index uvBottomLeft on a nil value" : e.Message);
		}
	}
	...
	static int get_uvBottomRight(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index uvBottomRight on a nil value" : e.Message);
		}
	}
	...
	static int get_uvTopRight(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index uvTopRight on a nil value" : e.Message);
		}
	}
	...
	static int get_uvTopLeft(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index uvTopLeft on a nil value" : e.Message);
		}
	}
