...
public static class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(System.Predicate<UnityEngine.UILineInfo>), System_Predicate_UnityEngine_UILineInfo);
		dict.Add(typeof(System.Action<UnityEngine.UILineInfo>), System_Action_UnityEngine_UILineInfo);
		dict.Add(typeof(System.Comparison<UnityEngine.UILineInfo>), System_Comparison_UnityEngine_UILineInfo);
		dict.Add(typeof(ZipTool.DelegateZipCall), ZipTool_DelegateZipCall);
		dict.Add(typeof(System.AsyncCallback), System_AsyncCallback);
		dict.Add(typeof(ToLuaFramework.DelegateThreadFunc), ToLuaFramework_DelegateThreadFunc);
		dict.Add(typeof(ToLuaFramework.DelegateThreadFuncCb), ToLuaFramework_DelegateThreadFuncCb);
		dict.Add(typeof(System.Predicate<object>), System_Predicate_object);
		dict.Add(typeof(System.Action<object>), System_Action_object);
		dict.Add(typeof(System.Comparison<object>), System_Comparison_object);
	}
	...
	public static Delegate System_Predicate_UnityEngine_UILineInfo(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
	...
	public static Delegate System_Action_UnityEngine_UILineInfo(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
	...
	public static Delegate System_Comparison_UnityEngine_UILineInfo(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
	...
	public static Delegate ZipTool_DelegateZipCall(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
	...
	public static Delegate ToLuaFramework_DelegateThreadFunc(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
	...
	public static Delegate ToLuaFramework_DelegateThreadFuncCb(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
