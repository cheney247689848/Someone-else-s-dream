...
require "scene/L_SceneMajorView"
require "scene/L_SceneMajorState"
require "type/L_TypeSceneState"
--场景类

local pData = L_ScenePreloading:GetPreLoadingData("Major")
L_SceneMajor = L_Scene.New( pData ~= nil and pData or {})
local _this = L_SceneMajor
...
function _this:ConfState()
    --state config
    _this.view = L_SceneMajorView --conn view class
    ...
    _this.stateLayout = L_SceneMajorState.stateLayout({m_nStatus = L_TypeSceneState.Layout} , _this)
    _this.stateProcess = L_SceneMajorState.stateProcess({m_nStatus = L_TypeSceneState.Process} , _this)
    _this.stateGlobal = L_SceneMajorState.stateGlobal({m_nStatus = L_TypeSceneState.Global} , _this)
